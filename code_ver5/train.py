...
def self_play(n_selfplay):
    ...
    for episode in range(n_selfplay):
        ...
        while win_index == 0:
            ...
            pi = Agent.get_pi(root_id, tau, epochs=ep)
            print("pi", pi)
            # ===================== collect samples ======================== #
...
if __name__ == '__main__':
    ...
    model_path = None #'../six/data/211020_3400_3092420_step_model.pickle'
    dataset_path = None #'../six/data/211020_3400_3092420_step_dataset.pickle'
