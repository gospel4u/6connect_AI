...
def self_play(n_selfplay):
    ...
    for episode in range(n_selfplay):
        ...
        while win_index == 0:
            ...
            # ======================== get action ========================== #
            if ep == 0:
                action, action_index = utils.get_action(pi, 1, count=ep)
            else:
                action, action_index = utils.get_action(pi, 0, count=ep)
            ep += 1
            #print("action", action)
...
def train(lr, n_epochs, n_iter):
    ...
    loss_p = []
    train_memory = []
    train_memory.extend(rep_memory)
    ...
    # for epoch in range(n_epochs): # n_epochs 1
...
if __name__ == '__main__':
    ...
    model_path = '/home/june/2021-2/six-ver2/data/211012_1800_1591620_step_model.pickle'
    dataset_path = '/home/june/2021-2/six-ver2/data/211012_1800_1591620_step_dataset.pickle'
    ...
    for n_iter in range(start_iter, TOTAL_ITER):
        ...
        if n_iter > 0:
            ...
            print("Training end epochs: ", n_iter)
        else:
            self_play(N_SELFPLAY)

        print("____________________SAVE MODEL___________________________")
        if n_iter % 100 == 0:
